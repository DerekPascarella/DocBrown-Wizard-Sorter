...
* Games can be removed by identifying the numbered folder in which they're stored by referencing the `\01\data\TITLES.TXT` file, and then processing SD card with DocBrown/Wizard Sorter.
